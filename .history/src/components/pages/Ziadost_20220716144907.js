  ...
  return (
    <>
      ...
      <form onSubmit={formik.handleSubmit} ref={formRef} name="google-sheet">
        ...
        Akceptujeme kópiu výpisu z účtu, stiahnutú z internet bankingu, alebo oskenovanú, prípadne kvalitne odfotenú kópiu. V prípade ak nie ste majiteľom účtu je potrebné doložiť dispozičné právu k účtu.
           </div>
          <div className="input-file-field">
            <Dropzone
              LayoutComponent={NoDropzoneLayout}
