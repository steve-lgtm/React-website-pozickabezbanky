...
export default function Ziadost() {
  ...
  const formik = useFormik({
    ...
    validate: (values) => {
      ...
      if (values.zamestnanie === "Zamestnanec na SK"||values.zamestnanie === "Zamestnanec v zahraničí"||values.zamestnanie === "Opatrovateľ živnostník EU"||values.zamestnanie === "Živnostník na SK"){
...
const showIfEmploy = () =>{
  ...
  if (formik.values.zamestnanie === "Zamestnanec na SK"||formik.values.zamestnanie === "Zamestnanec v zahraničí"||formik.values.zamestnanie === "Opatrovateľ živnostník EU"||formik.values.zamestnanie === "Živnostník na SK"){
  showifemploy.style.display = "block";
}
else{
    ...
    <>
      ...
      <form onSubmit={formik.handleSubmit} ref={formRef} name="google-sheet">
        <div className="container-form">
          ...
          <div className="section-name">Vyberte dobu splácania</div>
        ...
        <div className="personal-data">
          ...
          <div className="personal-data-field">
            ...
            />
            <div className="errors">
            {formik.errors.rodnéČíslo && formik.touched.rodnéČíslo ? <div>{formik.errors.rodnéČíslo}</div> : null}
            </div>
            </div>
            <div className="personal-data-field">
            ...
            />
            <div className="errors">
            {formik.errors.čísloOP && formik.touched.čísloOP ? <div>{formik.errors.čísloOP}</div> : null}
            </div>
            </div>
          <div className="personal-data-field">
        ...
        <div className="section-name">Zamestanie</div>
        <div className="if-employ">
          ...
          <input
            ...
            />
            <div className="errors">
            {formik.errors.názovZamestnávateľa && formik.touched.názovZamestnávateľa ? <div>{formik.errors.názovZamestnávateľa}</div> : null}
            </div>
            </div>
            <div className="if-employ">
          ...
          <input
            ...
            />
            <div className="errors">
            {formik.errors.IČOzamestnávateľa && formik.touched.IČOzamestnávateľa ? <div>{formik.errors.IČOzamestnávateľa}</div> : null}
            </div>
            </div>
            <div className="if-employ">
...
Nahrajte max. 3 súbory. (Najvhodnejšie 1-2 PDF súbory.)
          ...
          <div className="prechodne-bydlisko-field-suhlas-error">
            ...
            Súhlasím so spracovaním <a className="suhlasim" onClick={handleOpen}>osobných údajov.</a>
        </div>
        <div className="error-file-size">
...
>
  <Box sx={style}>
    <Button style={{left:250}} onClick={handleClose}><FontAwesomeIcon width={200} className="icona" icon="fa-solid fa-x" /></Button>
