...
const showIfEmploy = () =>{
  ...
  if (formik.values.zamestnanie === "Zamestnanec na SK"){
      ...
      <form onSubmit={formik.handleSubmit} ref={formRef} name="google-sheet">
        ...
        <div className="if-employ">
          ...
          <input
            ...
            />
            <div className="errors">
            {formik.errors.dátumDoZamestnania && formik.touched.dátumDoZamestnania ? <div>{formik.errors.IČOzamestnávateľa}</div> : null}
            </div>
            </div>
            </div>
        <div className="personal-data">
