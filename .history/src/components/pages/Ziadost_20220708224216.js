    ...
    <>
      ...
      <div className='container-form'>
       ...
       <h2>{formik.values.period}</h2>
            ...
            <input type="range" name="period" step="1" min="1" max="8" onChange={value => formik.handleChange;setMounthAmount(value)} value={formik.values.period} className="slider" id="doba"/>
            <div className="pullleft" style={{fontSize: "1rem"}}>
                min.
            </div>
            <div className="pullright" style={{fontSize: "1rem"}}>
