...
// Select options for input
  ...
  const optionsTypBývania= [
    { value: 'Základné', label: 'Vlastný byt/dom' },
    { value: 'Stredoškolské s maturitou', label: 'Družstevný byt' },
    { value: 'Stredoškolské bez maturity', label: 'Bývanie u rodičov/u detí' },
    { value: 'Vysokoškolské bakalárske', label: 'Najomné bývanie' },
    { value: 'Vysokoškolské', label: 'iné' },
  ]
