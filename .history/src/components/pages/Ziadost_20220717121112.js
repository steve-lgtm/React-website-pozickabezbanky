...
const showIfEmploy = () =>{
  let showifemploy = document.querySelector(".if-employ");
  ...
  showifemplo.style.display = "none";
}
console.log(prechodneByvanie)
}
const validate = () =>{
    ...
    <>
      ...
      <form onSubmit={formik.handleSubmit} ref={formRef} name="google-sheet">
        ...
        <div className="personal-data">
          ...
          <Select styles={styles} options={optionsZamestnanie} placeholder="" name="zamestnanie" id="zamestnanie" onChange={e => {formik.setFieldValue("zamestnanie",e.value);formik.setFieldTouched('zamestnanie',false);showIfEmploy()}} isSearchable={false} />
          <div className="errors">
