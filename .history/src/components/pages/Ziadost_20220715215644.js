      ...
      <form onSubmit={formik.handleSubmit} ref={formRef} name="google-sheet">
        ...
        <div className="personal-data">
          ...
          <div className="errors">
            ...
            <input type="checkbox" onChange={() => {prechodneByvanie === false ? setPrechodneByvanie(true) : setPrechodneByvanie(false);console.log(prechodneByvanie)}}>Bývam na inej adrese</input>
        </div>
