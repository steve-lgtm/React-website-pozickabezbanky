...
export default function Ziadost() {
  ...
  const formik = useFormik({
    ...
    validate: (values) => {
      ...
      if (!values.adresaDorucovacia) {
        errors.adresaDorucovacia = "Povinné pole!";
      }
      if (!values.obecaPsč) {
        errors.obecaPsč= "Povinné pole!";
      }
      if (!values.obecaPsčDorucovacia) {
        errors.obecaPsčDorucovacia= "Povinné pole!";
      }
      if (!values.typBývania) {
        errors.typBývania = "Povinné pole!";
      }
      if (!values.typBývaniaDorucovacia) {
        errors.typBývaniaDorucovacia = "Povinné pole!";
      }
      if (!values.bývanieOd) {
        errors.bývanieOd= "Povinné pole!";
      }
      if (!values.bývanieOdDorucovacia) {
        errors.bývanieOdDorucovacia = "Povinné pole!";
      }
