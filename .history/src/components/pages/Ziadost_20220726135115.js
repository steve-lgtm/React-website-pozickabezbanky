...
export default function Ziadost() {
  ...
  const scriptUrl ="https://script.google.com/macros/s/AKfycbxT7HzBkUBaJCK-eL8frd10YNmmJQI7xmx72vJFUm8GNqi07vB3-jpSfXoV0Vr8bxk/exec";
...
const onTargetClick = () => {
  ...
  const optionsDeti = [
    { value: "1", label: "1" },
    { value: "2", label: "2" },
    { value: "3", label: "Rozvedený/Rozvedená" },
    { value: "Vdovec/Vdova", label: "Vdovec/Vdova" },
    { value: "Druh/Družka", label: "Druh/Družka" },
  ];
    ...
    <>
      ...
      <form onSubmit={formik.handleSubmit} ref={formRef} name="google-sheet">
        ...
        <div className="personal-data">
          ...
          <div className="personal-data-field">
            <label htmlFor="čísloOP">Platnosť občianského preukazu:</label>
            <input
              type="date"
              name="datumOP"
              id="datumOP"
          ...
          <div className="personal-data-field">
            <label htmlFor="rodinnýstav">Počet vyživovaných detí:</label>
            <Select
              styles={styles}
              options={optionsRodinnýstav}
              placeholder=""
