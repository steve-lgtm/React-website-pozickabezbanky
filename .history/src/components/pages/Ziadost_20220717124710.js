...
export default function Ziadost() {
  ...
  const formik = useFormik({
    ...
    validate: (values) => {
      ...
      if (values.zamestnanie === "Zamestnanec na SK"||values.zamestnanie === "Zamestnanec v zahraničí"||formik.values.zamestnanie === "Opatrovateľ živnostník EU"||values.zamestnanie === "Živnostník na SK"){
