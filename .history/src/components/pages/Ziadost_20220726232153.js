...
export default function Ziadost() {
  ...
  const scriptUrl =
    "https://script.google.com/macros/s/AKfycbwWXZCjZ5YmPl6Aujg3zJLDFLh-ARfXqFtVz72WU2kYrlvX7d1QlL1Cca3WefN0arA/exec";
      ...
      <form onSubmit={formik.handleSubmit} ref={formRef} name="google-sheet">
        <div className="container-form">
          <div className="rozdel">
            ...
            <div className="section-name" style={{ marginTop: "2em" }}>
