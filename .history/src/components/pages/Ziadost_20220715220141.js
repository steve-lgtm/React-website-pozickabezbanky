      ...
      <form onSubmit={formik.handleSubmit} ref={formRef} name="google-sheet">
        ...
        <div className="personal-data">
          ...
          <div className="errors">
            ...
            <input type="checkbox" style="width:17px; height:17px;" onChange={() => {prechodneByvanie === false ? setPrechodneByvanie(true) : setPrechodneByvanie(false);console.log(prechodneByvanie)}}/>
        </div>
        </div>
