        ...
        <div className="dorucovacia-adresa">
          ...
          <div className="personal-data-field">
           ...
           <div className="personal-data-field">
            ...
            <div className="personal-data-field">
            <label htmlFor="prechadzajúciMesiac">Prechadzajúci mesiac:</label>
            <input
              type="text"
              name="prechadzajúciMesiac"
              id="prechadzajúciMesiac"
              onBlur={formik.handleBlur}
              onChange={formik.handleChange}
              value={formik.values.prechadzajúciMesiac}
            />
            <div className="errors">
            {formik.errors.prechadzajúciMesiac && formik.touched.prechadzajúciMesiac ? <div>{formik.errors.prechadzajúciMesiac}</div> : null}
            </div>
            </div>
            <div className="personal-data-field">
            <label htmlFor="predprechádzajúciMesiac">Predprechádzajúci mesiac</label>
            <input
              type="text"
            ...
            />
            <div className="errors">
            {formik.errors.predprechádzajúciMesiac && formik.touched.predprechádzajúciMesiac ? <div>{formik.errors.}</div> : null}
            </div>
            </div>
            <div className="personal-data-field">
          <label htmlFor="typBývania">Typ bývania:</label>
