...
// Select options for input
  ...
  const optionsVzdelanie= [
    { value: 'Slobodný/Slobodná', label: 'Základné' },
    { value: 'Ženatý/Vydatá', label: 'Stredoškolské s maturitou' },
    { value: 'Rozvedený/Rozvedená', label: 'Stredoškolské bez maturity' },
    { value: 'Vdovec/Vdova', label: 'Vysokoškolské bakalárske' },
    { value: 'Druh/Družka', label: 'Vysokoškolské' },
  ]
