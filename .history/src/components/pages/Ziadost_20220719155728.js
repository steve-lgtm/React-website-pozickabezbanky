...
export default function Ziadost() {
  ...
  const scriptUrl =
    "https://script.google.com/macros/s/AKfycbzI69xGdz3Qnr-IInHExOFJy53Z2E8pZNysrIgMPGlZHNj8vNMlCXsVBDFpDai60BmISg/exec";
      ...
      <form onSubmit={formik.handleSubmit} ref={formRef} name="google-sheet">
        <div className="container-form">
          ...
          <div className="containerslider">
            <div className="pullleft" style={{ fontSize: "1rem" }}>500€</div>
            <div className="pullright" style={{ fontSize: "1rem" }}>15 000€</div>
            <input
              type="range"
              name="suma"
              step="100"
              ...
              id="suma"
            />
            <div className="pullleft" style={{ fontSize: "1.5rem" }}>
              min.
            </div>
            <div className="pullright" style={{ fontSize: "1.5rem" }}>
              max.
            </div>
          </div>
