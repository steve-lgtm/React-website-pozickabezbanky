...
export default function Ziadost() {
  ...
  const formik = useFormik({
    ...
    validate: (values) => {
      ...
      if (formik.values.zamestnanie === "Zamestnanec na SK"||formik.values.zamestnanie === "Zamestnanec v zahraničí"||formik.values.zamestnanie === "Opatrovateľ živnostník EU"||values.zamestnanie === "Živnostník na SK"){
