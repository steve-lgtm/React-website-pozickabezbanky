    ...
    <>
      ...
      <form onSubmit={formik.handleSubmit} ref={formRef} name="google-sheet">
        ...
        <div className="dorucovacia-adresa">
          ...
          <Select styles={styles} options={optionsTypBývania} placeholder="" name="typBývania" id="typBývania" onChange={e => {formik.setFieldValue("príjemNaÚče",e.value);formik.setFieldTouched('typBývania',false)}} isSearchable={false} />
          <div className="errors">
