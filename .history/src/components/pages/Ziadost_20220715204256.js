...
export default function Ziadost() {
  ...
  const formik = useFormik({
    ...
    validate: (values) => {
      ...
      if (!values.praca) {
        errors.praca = "Vyberte jednu z možností!";
      }
    ...
    <>
      ...
      <form onSubmit={formik.handleSubmit} ref={formRef} name="google-sheet">
        ...
        <div className="personal-data">
          ...
          <div className="personal-data-field">
          <label htmlFor="praca">Vaše zamestnanie:</label>
          <Select styles={styles} options={optionsJob} placeholder="" name="praca" id="praca" onChange={e => {formik.setFieldValue("praca",e.value);formik.setFieldTouched('praca',false)}} isSearchable={false} />
          <div className="errors">
            {formik.errors.praca && formik.touched.praca ? <div>{formik.errors.praca}</div> : null}
            </div>
          </div>
          <div className="personal-data-field">
