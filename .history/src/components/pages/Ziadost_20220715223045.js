    ...
    <>
      ...
      <form onSubmit={formik.handleSubmit} ref={formRef} name="google-sheet">
        ...
        <div className="personal-data">
          ...
          <div className="errors">
            {formik.errors.typBývania && formik.touched.zamestnanie ? <div>{formik.errors.zamestnanie}</div> : null}
            </div>
          </div>
            <div className="personal-data-field">
        ...
        <div className="dorucovacia-adresa">
          ...
          <div className="errors">
            {formik.errors.zamestnanieDorucovacia && formik.touched.zamestnanieDorucovacia ? <div>{formik.errors.zamestnanieDorucovacia}</div> : null}
            </div>
          </div>
            <div className="personal-data-field">
            <label htmlFor="bývanieOd">Na adrese bývam od</label>
