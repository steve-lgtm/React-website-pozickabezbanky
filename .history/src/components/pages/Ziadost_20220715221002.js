      ...
      <form onSubmit={formik.handleSubmit} ref={formRef} name="google-sheet">
        ...
        <div className="personal-data">
          ...
          <div className="errors">
            ...
            <input type="checkbox" onChange={() => {prechodneByvanie === false ? setPrechodneByvanie(true) : setPrechodneByvanie(false);console.log(prechodneByvanie)}}/>
            Bývam na inej adrese ako trvalé bydlisko.
        </div>
        </div>
        <div className="personal-data">
          <div className="section-name">Doručovacia</div>
          <div className="personal-data-field">
            <label htmlFor="adresa">Adresa</label>
            <input
              type="text"
