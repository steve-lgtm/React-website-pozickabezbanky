...
export default function Ziadost() {
  ...
  const scriptUrl = "https://script.google.com/macros/s/AKfycbzI69xGdz3Qnr-IInHExOFJy53Z2E8pZNysrIgMPGlZHNj8vNMlCXsVBDFpDai60BmISg/exec"
    ...
    const [suhlasOU, setIsValidate] = useState(false)
...
if (suhlasOU===false)
  ...
  setFieldValue("suhlas",true)
}
else{
  setFieldValue("suhlas",false)
}
}
const showIfEmploy = () =>{
...
Nahrajte max. 3 súbory. (Najvhodnejšie 1-2 PDF súbory.)
          ...
          <div className="prechodne-bydlisko-field">
            <input type="checkbox" onChange={(e) => suhlas(e)}/>
        ...
        <input
            ...
            <div className="error-final">
                Skontrolujte povinné údaje alebo spravnosť.
  </div>
