      ...
      <div className='container-form'>
       ...
       <h2>{formik.values.period}</h2>
        ...
        <div className="info2">
          ...
          <label for="nameElm">Meno a priezvisko:</label>
      <input required type="text" name="Meno" id="nameid" size="15" maxlength="50" oninvalid="alert('Vyplňte meno!');"/>
      </div>
      <div className='personal-data-field'>
      <label for="nameElm">Rodné priezvisko matky:</label>
      <input required type="text" name="Meno" id="nameid" size="50" maxlength="50" oninvalid="alert('Vyplňte meno!');"/>
            </div>
            </div>
      </form>
