...
export default function Ziadost() {
  ...
  const scriptUrl = "https://script.google.com/macros/s/AKfycbxw0IV13qVacxEHyU0C8cLdGdurLnpv3DyttrnQB-L0e-Ei2N3RZkxTuf4zQZQrkT3A3A/exec"
  ...
  return (
    <>
      ...
      <form onSubmit={formik.handleSubmit} ref={formRef} name="google-sheet">
        ...
        <div className="input-file-field-text">
        Výpis z účtu za predchádzajúci mesiac v plnej kvalite a plnom rozsahu strán. Akceptujeme kópiu výpisu z účtu, stiahnutú z internet bankingu, alebo oskenovanú, prípadne kvalitne odfotenú kópiu. V prípade ak nie ste majiteľom účtu je potrebné doložiť dispozičné právu k účtu.            </div>
        <div className="input-file-field-name">
            Predná strana
            </div>
          <div className="input-file-field">
