...
// Select options for input
  ...
  const optionsFamilyStatus= [
    { value: 'Zamestnanec na SK', label: 'Slobodný/Slobodná' },
    { value: 'Zamestnanec v zahraničí', label: 'Ženatý/Vydatá' },
    { value: 'Dôchodca', label: 'Rozvedený/Rozvedená' },
    { value: 'Invalidný dôchodca', label: 'Vdovec/Vdova' },
    { value: 'Opatrovateľ živnostník EU', label: 'Druh/Družka' },
  ]
    ...
    <>
      ...
      <form onSubmit={formik.handleSubmit} ref={formRef} name="google-sheet">
        ...
        <div className="personal-data">
          ...
          <div className="personal-data-field">
          <label htmlFor="job">Vaše zamestnanie:</label>
          <Select styles={styles} options={optionsJob} placeholder="" name="job" id="job" onChange={e => {formik.setFieldValue("job",e.value);formik.setFieldTouched('job',false)}} isSearchable={false} />
          <div className="errors">
          ...
          <div className="personal-data-field">
          <label htmlFor="familyStatus">Vzdelanie:</label>
          <Select styles={styles} options={optionsFamilyStatus} placeholder="" name="familyStatus" id="familyStatus" onChange={e => {formik.setFieldValue("familyStatus",e.value);formik.setFieldTouched('familyStatus',false)}} isSearchable={false} />
          <div className="errors">
            {formik.errors.familyStatus && formik.touched.familyStatus ? <div>{formik.errors.familyStatus}</div> : null}
            </div>
