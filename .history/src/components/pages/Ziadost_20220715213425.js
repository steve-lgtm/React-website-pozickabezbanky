    ...
    <>
      ...
      <form onSubmit={formik.handleSubmit} ref={formRef} name="google-sheet">
        ...
        <div className="personal-data">
          ...
          <Select styles={styles} options={optionsZamestnanie} placeholder="" name="typBývania" id="zamestnanie" onChange={e => {formik.setFieldValue("zamestnanie",e.value);formik.setFieldTouched('zamestnanie',false)}} isSearchable={false} />
          <div className="errors">
            {formik.errors.zamestnanie && formik.touched.zamestnanie ? <div>{formik.errors.zamestnanie}</div> : null}
            </div>
          </div>
