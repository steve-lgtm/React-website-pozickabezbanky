    ...
    <>
      ...
      <div className='container-form'>
        <div className='section-name'>Požadovaná suma</div>
            ...
            <input type="range" name="Výška_pôžičky" step="100" min="500" max="15000" onChange={handleChange} value={values.amount} className="slider" id="suma"/>
