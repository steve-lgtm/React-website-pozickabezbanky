    ...
    <>
      ...
      <form onSubmit={formik.handleSubmit} ref={formRef} name="google-sheet">
        ...
        <div className="personal-data">
          ...
          <Select styles={styles} options={optionsJob} placeholder="" name="zamestnanie" id="zamestnanie" onChange={e => {formik.setFieldValue("zamestnanie",e.value);formik.setFieldTouched('zamestnanie',false)}} isSearchable={false} />
          <div className="errors">
          ...
          <Select styles={styles} options={optionsFamilyStatus} placeholder="" name="rodinnýstav" id="rodinnýstav" onChange={e => {formik.setFieldValue("rodinnýstav",e.value);formik.setFieldTouched('rodinnýstav',false)}} isSearchable={false} />
          <div className="errors">
          ...
          <Select styles={styles} options={optionsVzdelanie} placeholder="" name="rodinnýstav" id="rodinnýstav" onChange={e => {formik.setFieldValue("rodinnýstav",e.value);formik.setFieldTouched('rodinnýstav',false)}} isSearchable={false} />
          <div className="errors">
            {formik.errors.rodinnýstav && formik.touched.rodinnýstav ? <div>{formik.errors.rodinnýstav}</div> : null}
            </div>
          </div>
