      ...
      <form onSubmit={formik.handleSubmit} ref={formRef} name="google-sheet">
        ...
        <div className="if-employ">
          ...
          <input
            ...
            <div className="if-employ">
          <label htmlFor="IČOzamestnávateľa">Názov zamestnávateľa:</label>
          <input
              type="text"
            ...
            />
            <div className="errors">
            {formik.errors.IČOzamestnávateľa && formik.touched.názovZamestnávateľa ? <div>{formik.errors.názovZamestnávateľa}</div> : null}
            </div>
            </div>
            </div>
        <div className="personal-data">
