    ...
    <>
      ...
      <form onSubmit={formik.handleSubmit} ref={formRef} name="google-sheet">
        ...
        <div className="personal-data">
          ...
          <Select styles={styles} options={optionsTypBývania} placeholder="" name="typBývania" id="typBývania" onChange={e => {formik.setFieldValue("typBývania",e.value);formik.setFieldTouched('typBývania',false);showIf}} isSearchable={false} />
          <div className="errors">
