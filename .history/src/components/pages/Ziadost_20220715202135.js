    ...
    <>
      ...
      <form onSubmit={formik.handleSubmit} ref={formRef} name="google-sheet">
        ...
        <div className="personal-data">
          ...
          <Select styles={styles} options={optionsFamilyStatus} placeholder="" name="job" id="job" onChange={e => {formik.setFieldValue("job",e.value);formik.setFieldTouched('job',false)}} isSearchable={false} />
          <div className="errors">
            {formik.errors.job && formik.touched.job ? <div>{formik.errors.job}</div> : null}
            </div>
          </div>
