...
export default function Ziadost() {
  ...
  const formik = useFormik({
    ...
    validate: (values) => {
      ...
      if (!values.práca) {
        errors.práca = "Vyberte jednu z možností!";
      }
    ...
    <>
      ...
      <form onSubmit={formik.handleSubmit} ref={formRef} name="google-sheet">
        ...
        <div className="personal-data">
          ...
          <div className="personal-data-field">
          <label htmlFor="práca">Vaše zamestnanie:</label>
          <Select styles={styles} options={optionsJob} placeholder="" name="práca" id="práca" onChange={e => {formik.setFieldValue("práca",e.value);formik.setFieldTouched('práca',false)}} isSearchable={false} />
          <div className="errors">
            {formik.errors.práca && formik.touched.práca ? <div>{formik.errors.práca}</div> : null}
            </div>
          </div>
          <div className="personal-data-field">
