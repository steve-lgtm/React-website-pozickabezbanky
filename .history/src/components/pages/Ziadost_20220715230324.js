        ...
        <div className="dorucovacia-adresa">
          ...
          <div className="personal-data-field">
           ...
           <div className="personal-data-field">
            ...
            <div className="personal-data-field">
            <label htmlFor="predprechadzajúciMesiac">predprechadzajúci mesiac:</label>
            <input
              type="text"
              name="predprechadzajúciMesiac"
              id="predprechadzajúciMesiac"
              onBlur={formik.handleBlur}
              onChange={formik.handleChange}
              value={formik.values.predprechadzajúciMesiac}
            />
            <div className="errors">
            {formik.errors.predprechadzajúciMesiac && formik.touched.predprechadzajúciMesiac ? <div>{formik.errors.predprechadzajúciMesiac}</div> : null}
            </div>
            </div>
            <div className="personal-data-field">
            <label htmlFor="predPredprechadzajúciMesiac"></label>
            <input
              type="text"
              name=""
              id=""
