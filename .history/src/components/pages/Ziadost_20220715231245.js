        ...
        <div className="dorucovacia-adresa">
          ...
          <div className="personal-data-field">
           ...
           <div className="personal-data-field">
            ...
            <div className="personal-data-field">
            <label htmlFor="prechádzajúciMesiac">Prechadzajúci mesiac:</label>
            <input
              type="text"
            ...
            <div className="personal-data-field">
            <label htmlFor="predPrechádzajúciMesiac">Prechadzajúci mesiac:</label>
            <input
              type="text"
            ...
            />
            <div className="errors">
            {formik.errors.predPrechádzajúciMesiac && formik.touched.predPrechádzajúciMesiac ? <div>{formik.errors.prechádzajúciMesiac}</div> : null}
            </div>
            </div>
            <div className="personal-data-field">
          <label htmlFor="príjemNaÚčet">Dostávate príjem na účet</label>
          <Select styles={styles} options={optionsPríjemNaÚčet} placeholder="" name="typBývania" id="typBývania" onChange={e => {formik.setFieldValue("príjemNaÚče",e.value);formik.setFieldTouched('príjemNaÚče',false)}} isSearchable={false} />
          <div className="errors">
            {formik.errors.príjemNaÚče && formik.touched.príjemNaÚče ? <div>{formik.errors.príjemNaÚče}</div> : null}
            </div>
          </div>
            </div>
