...
export default function Ziadost() {
  ...
  const formik = useFormik({
    ...
    validate: (values) => {
      ...
      if (!values.rodinn) {
        errors.rodinn = "Vyberte jednu z možností!";
      }
    ...
    <>
      ...
      <form onSubmit={formik.handleSubmit} ref={formRef} name="google-sheet">
        ...
        <div className="personal-data">
          ...
          <div className="personal-data-field">
          <label htmlFor="rodinn">Rodinný stav:</label>
          <Select styles={styles} options={optionsFamilyStatus} placeholder="" name="rodinn" id="rodinn" onChange={e => {formik.setFieldValue("rodinn",e.value);formik.setFieldTouched('rodinn',false)}} isSearchable={false} />
          <div className="errors">
            {formik.errors.rodinn && formik.touched.rodinn ? <div>{formik.errors.rodinn}</div> : null}
            </div>
          </div>
          <div className="personal-data-field">
